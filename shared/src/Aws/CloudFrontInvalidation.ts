import {
  type CloudFrontClient, CreateInvalidationCommand, type CreateInvalidationCommandOutput,
...
export class CloudFrontInvalidation {
  ...
  constructor({ cloudFrontClient, distributionId, paths }: Options) {
  ...
  public invalidate(): Promise<CreateInvalidationCommandOutput> {
    // Creates timestamp in the following format: "2021-02-22T12:40:57".
